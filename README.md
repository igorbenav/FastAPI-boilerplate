...
1. Test your changes while in the root folder `poetry run python -m pytest`
1. Install pre-commit `pip install pre-commit` and install the hooks `pre-commit install`
